...
func RegisterPostHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PostServer) error {
	...
	mux.Handle("POST", pattern_Post_CreatePost_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/post.v1.Post/CreatePost", runtime.WithHTTPPathPattern("/api/v1/post"))
		if err != nil {
...
func RegisterPostHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PostClient) error {
	...
	mux.Handle("POST", pattern_Post_CreatePost_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/post.v1.Post/CreatePost", runtime.WithHTTPPathPattern("/api/v1/post"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Post_CreatePost_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "post"}, ""))
)
